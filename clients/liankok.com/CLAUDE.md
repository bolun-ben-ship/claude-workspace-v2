# Lian Kok Electrical — Claude Workspace

## Client
- **Name:** Lian Kok Electrical Pte Ltd
- **Website:** https://liankok.com
- **Market:** Singapore
- **Niche:** Electrical products distribution — ABB authorised distributor, low voltage products & wiring accessories
...
- **Outputs:** `Content & SEO/outputs/wordpress-liankok/`
...
## Analytics
- GSC site: https://liankok.com/
- GA4 property ID: 474641068
- Google credentials: `LIANKOK_GOOGLE_KEY` (env var → path to JSON key file)
  - JSON file lives at: `clients/liankok.com/liankok-*.json` (gitignored)
  - Set in `~/.zshrc`: `export LIANKOK_GOOGLE_KEY="$HOME/Antigravity/RightClickAI-seo-workspace/clients/liankok.com/liankok-seo-*.json"`
...
```
Content & SEO/outputs/wordpress-liankok/
...
## Voice & Tone
Technical authority with approachability — trusted industry expert speaking to contractors, engineers, and building owners. Professional, precise, and reassuring. Avoid overly casual language; this is a B2B/trade context.
